    ...
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-md z-50">
        <div className="flex justify-around items-center py-2">
          ...
          <Link to="/zelle" className="flex flex-col items-center text-sm text-gray-600 hover:text-blue-600">
            <FaExchangeAlt className={`text-xl ${location.pathname === "/zelle" && "text-blue-600"}`} />
            <span>Zelle</span>
          </Link>
          <Link to="/cards" className="flex flex-col items-center text-sm text-gray-600 hover:text-blue-600">
