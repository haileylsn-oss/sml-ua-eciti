...
<div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-xl border border-red-300 text-left text-sm">
  <h2 className="text-red-800 font-bold text-lg mb-2">
    🚫 Transfer Access Restricted – Pending Tax Settlement
  </h2>
  ...
  <p className="text-gray-700 mb-4">
    As per <strong>Citi Bank UAE Compliance Policy</strong> and Central Bank
    of the UAE financial regulations, your account must settle all outstanding
    tax obligations prior to initiating transfers.
  </p>
  ...
  <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
    ...
    <p>
      ...
      <span className="font-semibold text-red-700">AED 124,327.68 </span>  equivalent to   <span className="font-semibold text-red-700">$33,850</span> <br />
      required to activate transfer functionality on this account.
    </p>
    <p className="mt-2">
      This payment is part of standard compliance under UAE financial tax
      regulations and must be fulfilled in full before transfers can be
      enabled.
    </p>
  </div>
    ...
    <ul className="list-disc list-inside text-gray-700 space-y-1">
      <li>
        ...
        <span className="text-red-600 font-semibold">
          Disabled – Tax Settlement Incomplete
        </span>
      </li>
      <li>
        Compliance Tier: <strong>Tax Clearance Required</strong>
      </li>
      <li>
        Reserve Status:{" "}
  ...
  <p className="text-gray-700 mb-4">
    ...
    full. No exceptions are permitted under current Citi Bank UAE compliance
    protocol.
  </p>

  <p className="text-xs text-gray-500 mb-6">
    🔐 Regulation: This requirement is enforced in accordance with{" "}
    <strong>UAE Federal Tax Authority (FTA)</strong> guidelines and
    monitored under Central Bank of the UAE compliance safeguards.
  </p>
