  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
    ...
    <div>
      <h4 className="text-xs font-semibold text-gray-600 uppercase">
        Citi® USA & Mexico Banking
      </h4>
      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2">
        Discover the right Citi® banking solutions across the Americas
      </h1>
      <p className="mt-4 text-gray-600 text-sm md:text-base max-w-md">
        ...
        Cross-Border Banking, Citi USA & Mexico is here to support your financial goals
